            ...
            <div className='row shadow rounded-4'>
                <div className='col-6 col-md-3 border-end p-4'>
                    ...
                    <div className='d-flex justify-content-between align-items-center'>
                        ...
                        <h2 className='main-color'><i className="fa-solid fa-earth-americas"></i></h2>
                    </div>
                ...
                <div className='col-6 col-md-3 border-end p-4'>
                    ...
                    <div className='d-flex justify-content-between align-items-center'>
                        ...
                        <h2 className='sub-color2'><i className="fa-solid fa-calendar-check"></i></h2>
                    </div>
                ...
                <div className='col-6 col-md-3 border-end p-4'>
                    ...
                    <div className='d-flex justify-content-between align-items-center'>
                        ...
                        <h2 className='main-color'><i className="fa-solid fa-users-line"></i></h2>
                    </div>
